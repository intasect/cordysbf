...
/**
 * Class containing CoBOC condition template XForm information.
 *
 * @author mpoyhone
 */
public class ConditionTemplateXForm extends XmlStoreContentBase
{
    /**
     * Contains the handle of the condition template.
     */
    private CobocContentHandle cchConditionTemplateHandle = new CobocContentHandle(EContentType.COBOC_FOLDERS_CONDITIONTEMPLATE);
    /**
    ...
    static {
        try
        {
            ...
            axXFormContentTemplateKeyPath = new AXIOMXPath("./xformhtml/@ct_key");
        }
     ...
     */
    public ConditionTemplateXForm()
    {
        super(EContentType.COBOC_FOLDERS_CONDITIONTEMPLATE_XFORM);
    }
    ...
    public void updateReferences(IContentSource csSrc) throws BFException
    {
        ...
        if (csSrc.getType() == EContentSourceType.BCP ||
            ...
            if (cchConditionTemplateHandle.getObjectId() == null) {
                if (sName != null) {
                    ...
                    if (iPos >= 0) {
                        ...
                        cchConditionTemplateHandle.setObjectId(sId);                                                
                    }
                }
            }
            
            CobocUtils.updateCobocHandle(bcContext, cchConditionTemplateHandle);
        }
    }
    ...
    public Collection<IContentHandle> getReferencedContent()
    {
        ...
        if (cchConditionTemplateHandle != null) {
            lRes.add(cchConditionTemplateHandle);
        }
    ...
    {
        ConditionTemplateXForm atxWriteVersion = (ConditionTemplateXForm) super.createWriteVersion(csDest);
        
        if (csDest.getType() == EContentSourceType.BCP ||
            csDest.getType()  == EContentSourceType.ISV) {
            CobocUtils.updateCobocHandle(bcContext, cchConditionTemplateHandle);
            
            String sTemplateId = cchConditionTemplateHandle.getObjectId();
            ...
            if (oaAttrib == null) {
                ...
                oeRoot.getFirstElement().addAttribute("ct_key", cchConditionTemplateHandle.getKey(), onNamespace);
            } else {
                oaAttrib.setAttributeValue(cchConditionTemplateHandle.getKey());
            }
        }
    ...
    public IContentHandle getHandleForContentSource(IContentSource csSource)
    {
        if (csSource.getType() == EContentSourceType.BCP ||
            ...
            if (sTemplateId != null) {
                XmlStoreContentHandle xscRes = new XmlStoreContentHandle(EContentType.COBOC_FOLDERS_CONDITIONTEMPLATE_XFORM);
    ...
    public void onLoad(IContentSource csSrc) throws BFException
    {
        ...
        if (csSrc.getType() == EContentSourceType.FILESYSTEM) {
            ...
            cchConditionTemplateHandle.setKey(sTemplateKey);
        }
    }
    ...
    public String getFileSystemName() {
        String sTemplateKey = cchConditionTemplateHandle.getKey();
