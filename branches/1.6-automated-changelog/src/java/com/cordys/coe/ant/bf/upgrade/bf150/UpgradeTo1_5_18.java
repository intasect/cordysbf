...
/**
 * This class upgrades the project to the 1.5.18 level. The things that need
 * to be done:<br>
 * 1. Copy the build.xml to the project root (classpath generation is modified).<br>
 *
 * @author mpoyhone
 */
public class UpgradeTo1_5_18 extends UpdateScriptBase
{
    /**
