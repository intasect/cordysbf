...
/**
 * A wrapper class for CoBOC GetCollection method.
 *  
 * @author mpoyhone
 */
public class GetCollection extends MethodBase {
    /**
     * This method retrieves the collection for a certain type and filter from
     * CoBOC.  ## Copied from com.cordys.tools.at.cm.CoBOCHandler (mpoyhone)
     * ##
     *
     * @param swSoap The SOAP wrapper to use.
     * @param sFolder The name of the folder.
     ...
     */
    public int execute(ISoapRequestManager srmSoap, String sFolder,
                              String sFilter, String sType,
                              String sLevel, long lTimeout)
                             throws SoapRequestException
    {
        return execute(srmSoap, sFolder, sFilter, sType, sLevel, lTimeout,
                             null);
    }
     ...
     * @return The received response.
     *
     * @throws SoapRequestException Thrown if the SOAP request failed
     */
    public int execute(ISoapRequestManager srmSoap, String sFolder,
                                    String sFilter, String sType,
                                    String sLevel, long lTimeout,
                             ...
                             throws SoapRequestException
    {
        ...
        iMethodNode = srRequest.addMethod(CoBOCMethods.NSP_COBOC, CoBOCMethods.MTD_GETCOLLECTION);
        int iParamNode = Node.createTextElement("folder", sRealFolder, iMethodNode);
	...
	public String getMethodName() {
		return CoBOCMethods.MTD_GETCOLLECTION;
	}
