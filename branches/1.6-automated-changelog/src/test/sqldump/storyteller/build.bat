...
set ANT_CP=%ANT_CP%;%CD%\..\buildtasks.jar
set ANT_CP=%ANT_CP%;%CD%\..\..\..\..\sdk\optional.jar
set ANT_CP=%ANT_CP%;%CD%\..\..\..\..\lib\coelib.jar
set ANT_CP=%ANT_CP%;%CD%\..\..\..\..\lib\jldap.jar
set ANT_CP=%ANT_CP%;%CD%\..\..\..\..\lib\wcp.jar
set ANT_CP=%ANT_CP%;%CD%\..\..\..\..\lib\xerces.jar

%JAVA_HOME%\bin\java.exe -Xmn100M -Xms500M -Xmx500M -cp %ANT_CP% org.apache.tools.ant.Main %*
goto :end
