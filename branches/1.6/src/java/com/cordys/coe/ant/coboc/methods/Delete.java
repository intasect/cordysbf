...
public class Delete extends MethodBase
{
    ...
    {
        return CoBOCMethods.MTD_DELETE;
    }
    ...
    /**
     * This method delete an object from the CoBOC DB (works at least with
     * template attributes).
     *
                ...
                throws SoapRequestException
    {
        ...
        iMethodNode = srRequest.addMethod(CoBOCMethods.NSP_COBOC, CoBOCMethods.MTD_DELETE, Node.clone(iContentNode, true));
