...
/**
 * This class makes sure the update is done properly. This is actually the same
 * as 1.6.7 plus error level change in the build.bat
 * 
 ...
 * @author mpoyhone
  */
public class UpgradeTo1_6_9 extends UpdateScriptBase
{
    /**
