...
/**
 * Class for reading and writing CoBOC and file content map objects. The
 * ContentMapping class is the container for individual content maps and this
 * class contains the implementations.
 *
 * @author mpoyhone
 */
public class ContentMappingHandler extends FolderObjectHandler
{
    /**
     * Creates a new ContentMappingHandler instance.
     *
     * @param ccContext The CoBOCContext that is used when storing and accesing
     *        CoBOC objects.
     */
    public ContentMappingHandler(CoBOCContext ccContext)
    {
        super(ccContext);
    }
    ...
    {
        return ContentMapping.isContentMapping(iFileNode) ? iFileNode : 0;
    }
    ...
    {
        return ContentMapping.findContentMappingById(ccContext, sEntityId,
                                                     bCreate);
    }
    ...
    public CoBOCObject findObjectByPathKey(String sEntityPathKey,
                                           boolean bCreate)
    {
        return ContentMapping.findContentMappingByPathKey(ccContext,
                                                          sEntityPathKey,
                                                          bCreate);
    }
    ...
    {
        return FolderCallback.MASK_CONTENT_MAPPING;
    }
                               ...
                               throws ContentException
    {
        ...
        Node.setAttribute(xUpdateRequestNode, "template", "/CONTENTMAP");
