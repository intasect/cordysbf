...
public class @classname@
{
     ...
     */
    private static final String TMP_VERSION_PATCH = new String("@patchnumber@");
    /**
    ...
    static
    {
        if (!GENERATED.equals("@" + "generated" + "@"))
        {
            ...
            try
            {
                VERSION_PATCH = Integer.parseInt(TMP_VERSION_PATCH);
            }
            catch (Exception e)
            {
                //Ignore it.
    ...
    {
        return VERSION_MAJOR_MINOR + "." + VERSION_PATCH + "." + VERSION_MILESTONE;
    }
    ...
    public static String getVersionInfo(boolean bIncludeSystemInfo)
    {
        ...
        if (!REVISION_NUMBER.equals("@" + "revisionnumber" + "@"))
        {
