...
/**
 * This class upgrades the project to the 1.5.16 level. The things that need
 * to be done:<br>
 * 1. Copy the build.xml to the project root (since the project.properties
 * does not include project site settings anymore).<br>
 *
 * @author mpoyhone
 */
public class UpgradeTo1_5_16 extends UpdateScriptBase
{
    /**
