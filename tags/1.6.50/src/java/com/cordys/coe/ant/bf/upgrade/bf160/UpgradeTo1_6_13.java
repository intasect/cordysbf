...
/**
 * This class makes sure the update is done properly. Copies the 
 * the build.bat to make sure that the "exit /B" is present. If not,
 * the command prompt will terminate after build command.
 * 
 * Remember to add this class to method:
 * com.cordys.coe.ant.bf.upgrade.UpgradeManagerTask.registerScript()
 *
 * @author mpoyhone
  */
public class UpgradeTo1_6_13 extends UpdateScriptBase
{
    /**
