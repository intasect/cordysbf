 ...
 * <pre>
 *  	&lt;toolbars loader=&quot;com.eibus.contentmanagement.ISVSOAPManager&quot; description=&quot;Menus&quot;&gt;
 ...
 * @author msreejit
 */
public class Toolbars extends XMLStore
    implements ISVContentHandler
{
    /**
     * The xpath pattern to be matched in the content XML passed.
     */
    private static final String CONTENT_TAG_MATCH_PATTERN = "<toolbars><menu>";
    /**
     ...
     */
    private static final String ISV_CONTENT_ROOT_TAG = "toolbars";
    /**
     * The root tag of the developer content.
     */
    private static final String CONTENT_ROOT_TAG = "toolbars";
    /**
     * The description of the isv content loader.
     */
    private static final String ISV_CONTENT_DESCRIPTION = "Toolbars";
